...
public class VirtualPathGenerator
{
    ...
    public static void InitRandomState(int x) {
        Random.InitState(x);             
    }
    ...
    public struct PathSeed
    {
        ...
        {            
            //SamplingDistribution distanceSamplingDistribution = new SamplingDistribution(DistributionType.Uniform, 0.2f, 1.0f);
            SamplingDistribution distanceSamplingDistribution = new SamplingDistribution(DistributionType.Uniform, 1, 3);
            ...
            int waypointCount = 4000;
            //int waypointCount = 1000;
            return new PathSeed(distanceSamplingDistribution, angleSamplingDistribution, waypointCount);
        }
    ...
    public static List<Vector2> GenerateInitialPathByPathSeed(PathSeed pathSeed, float targetDist, out float sumOfDistances, out float sumOfRotations)
    {
        ...
        for (; !finished;)
        {
            ...
            nextPosition = GetRandomPositionWithinBounds(-50.0f, 50.0f, -50.0f, 50.0f);
