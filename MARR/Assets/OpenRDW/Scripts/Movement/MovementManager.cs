...
public class MovementManager : MonoBehaviour {
    ...
    void InstantiateSimulationPrefab()
    {
        ...
        Vector3 a = new Vector3(Random.Range(0,1),0,Random.Range(0,1));
        waypoint.position = new Vector3(22,1.2f, -15);//1.2f * Vector3.up + 1000 * a;
    ...
    {
        return redirectionManager.IfWaitTooLong() || generalManager.statisticsLogger.IfResetCountExceedLimit(avatarId);
    }
