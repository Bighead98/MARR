...
public class TrackingSpaceGenerator
{
    ...
    public static void GenerateSquareTrackingSpace(int obstacleType, out List<Vector2> trackingSpacePoints, out List<List<Vector2>> obstaclePolygons, out List<InitialConfiguration> initialConfigurations, float width,float height)
    {
        ...
        switch (obstacleType) {
            case 0:
                initialConfigurations = new List<InitialConfiguration>();
                for(int i=0;i<8;i++){
                    Vector2 ip = new Vector2(Random.Range(-width/2,width/2),Random.Range(-height/2,height/2) );
                    Vector2 id = new Vector2(Random.Range(-1,1), Random.Range(-1,1)).normalized;
                    
                    initialConfigurations.Add(new InitialConfiguration(ip, id));
                }
                break;
            case 1:                
                obstaclePolygons.Add(new List<Vector2> {
                    new Vector2(width/4,height/6),
                ...
                for(int i=0;i<8;i++){
                    ...
                    bool flag = true;
                    while(flag){
                        foreach(var p in obstaclePolygons){
                            flag = Utilities.IfPosInPolygon(p,ip);
                            if(flag){
                                ip = new Vector2(Random.Range(-width/2,width/2),Random.Range(-height/2,height/2) );
                                break;
                            }
                        }
                    }
            ...
            case 2:
                obstaclePolygons.Add(new List<Vector2> {
                    new Vector2(width/2,-height/2),
                    new Vector2(width/2,-height/10*3),
                    new Vector2(width*3/10,-height*3/10),
                    new Vector2(width*3/10,-height/2),
                });
                obstaclePolygons.Add(new List<Vector2> {
                    new Vector2(width/6,height/8),
                    new Vector2(width/8,0),
                    new Vector2(width/24*5,0),
                });
                obstaclePolygons.Add(new List<Vector2> {
                    new Vector2(width/6,height/3),
                    new Vector2(width/6,height/2),
                    new Vector2(-width/6,height/2),
                    new Vector2(-width/6,height/3),
                });

                obstaclePolygons.Add(new List<Vector2> {
                    new Vector2(-width/10*3,-height/10),
                    new Vector2(-width/10*3,height/10),
                    new Vector2(-width/2,height/10),
                    new Vector2(-width/2,-height/10),
                });

                // 없앨놈
                obstaclePolygons.Add(new List<Vector2> {
                    new Vector2(0,-height/10*3),
                    new Vector2(0,-height/10*2),
                    new Vector2(-width/10,-height/10*2),
                    new Vector2(-width/10,-height/10*3),
                });

                // // 추가할놈
                // obstaclePolygons.Add(new List<Vector2> {
                //     new Vector2(width/20*7,height/4),
                //     new Vector2(width/4,height/4),
                //     new Vector2(width/4,height/20*3),
                //     new Vector2(width/20*7,height/20*3),
                // });
                ...
                obstaclePolygons.Add(new List<Vector2> {
                    new Vector2(-width/2,height/2),
                    new Vector2(-width/2,height*3/10),
                    new Vector2(-width*3/10,height*3/10),
                    new Vector2(-width*3/10,height/2),
                });
                obstaclePolygons.Add(new List<Vector2> {
                    new Vector2(-7*width/24,-height/8),
                    new Vector2(-width/3,-height/4),
                    new Vector2(-6*width/24,-height/4),
                });
                obstaclePolygons.Add(new List<Vector2> {
                    new Vector2(width/6,-height/3),
                    new Vector2(width/6,-height/2),
                ...
                obstaclePolygons.Add(new List<Vector2> {
                    ...
                    new Vector2(width/5,0),
                    new Vector2(width/5,height/10),
                });
                obstaclePolygons.Add(new List<Vector2> {
                    new Vector2(width/2,height/2),
                    new Vector2(width/10*3,height/2),
                    new Vector2(width/10*3,height/10*3),
                    new Vector2(width/2,height/10*3),
                });
                */
                initialConfigurations = new List<InitialConfiguration>();
            ...
            case 3:
                obstaclePolygons.Add(new List<Vector2> {
                    new Vector2(width/10*3,width/10*3),
                    new Vector2(width/10,width/10*3),
                    new Vector2(width/10,width/10),
                    new Vector2(width/10*3,width/10),
                });
                obstaclePolygons.Add(new List<Vector2> {
                    new Vector2(-width/10*3,width/10*3),
                    new Vector2(-width/10*3,width/10),
            ...
            case 4:
                float d = width/10.0f;
                List<Vector2> ass = new List<Vector2>();
                for(float angle=0.0f;angle<360.0f;angle+=1.0f){
                    Vector2 b = new Vector2(d*Mathf.Cos(angle * Mathf.Deg2Rad), d*Mathf.Sin(angle * Mathf.Deg2Rad));
                    ass.Add(b);
                }
                obstaclePolygons.Add(ass);
            ...
            case 5:
                obstaclePolygons.Add(new List<Vector2> {
                    ...
                    new Vector2(-width/2+3,-height/2+2),
                    new Vector2(-width/2,-height/2+2),
                });
    ...
    public static void GenerateSquareTrackingSpace(int obstacleType, out List<Vector2> trackingSpacePoints, out List<List<Vector2>> obstaclePolygons, out List<InitialConfiguration> initialConfiguration)
    {
        GenerateSquareTrackingSpace(obstacleType, out trackingSpacePoints, out obstaclePolygons, out initialConfiguration, DEFAULT_TRACKING_SPACE_RADIUS, DEFAULT_TRACKING_SPACE_RADIUS);
    }
